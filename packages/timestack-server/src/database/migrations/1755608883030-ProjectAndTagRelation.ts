...
export class ProjectAndTagRelation1755608883030 implements MigrationInterface {
    name = 'ProjectAndTagRelation1755608883030'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "core"."user" ALTER COLUMN "workspace_id" SET DEFAULT gen_random_uuid()`);
